switch (KP_liberation_preset_blufor) do {
	...
	case 9: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\ifa_us_army.sqf";};
...
switch (KP_liberation_preset_opfor) do {
	...
	case 5: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\ifa_wehrmacht.sqf";};
